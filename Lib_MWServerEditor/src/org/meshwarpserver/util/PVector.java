...
public class PVector {
   ...
   */
  public void rotZ(double r){
	  float x1 = x * (float)Math.cos(r) + y * (float)Math.sin(r);
	  float y1 = y * (float)Math.cos(r) - x * (float)Math.sin(r);
	  x = x1;
	  y = y1;
  }
   ...
   */
  public void rotY(double r){
	  float x1 = x * (float)Math.cos(r) - z * (float)Math.sin(r);
	  float z1 = z * (float)Math.cos(r) + x * (float)Math.sin(r);
	  x = x1;
	  z = z1;
  }
   ...
   */
  public void rotX(double r){
	  float y1 = y * (float)Math.cos(r) + z * (float)Math.sin(r);
	  float z1 = z * (float)Math.cos(r) - y * (float)Math.sin(r);
	  y = y1;
	  z = z1;
  }
